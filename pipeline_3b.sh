...
then
    ...
    bash ./data_processing/fasttext/fasttext_filter.sh ${FASTTEXT_NAME} ${HDFS_PATH}/FasttextModel/ ${HDFS_PATH}/DCLM-refinedweb/3B-pool-1T ${HDFS_PATH}/DCLM-refinedweb/3B-${FASTTEXT_NAME}${VARIENT_NAME} ${LABEL_NAME} ${PERCENTAGE_THRESHOLD}
else
